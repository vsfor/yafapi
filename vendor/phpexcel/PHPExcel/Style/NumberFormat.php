...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	private static function _formatAsDate(&$value, &$format)
	{
        ...
        $format = \common\extend\phpexcel\JExcel::getInstance()->dateFormat;//set by Jeen @ louli todo
	...
	{
        //set by Jeen to prevent auto format todo
        if(\common\extend\phpexcel\JExcel::getInstance()->preventFormat) return $value;
